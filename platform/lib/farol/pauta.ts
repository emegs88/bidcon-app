  ...
  const mensagens: Array<{ role: string; content: unknown }> = [
    {
      ...
      content: [
        ...
        "vídeo curto (Reels/Shorts/TikTok) sobre as POSSIBILIDADES que as pessoas",
        "perseguem com dinheiro: sair do aluguel, ter a casa própria, quitar",
        "dívida cara, trocar o carro de trabalho, construir ou reformar, comprar",
        "à vista com poder de negociação, comprar a sede da empresa.",
        "",
        "O ASSUNTO É O DESEJO DE QUEM ASSISTE, não o produto financeiro que",
        "realiza o desejo. Ignore ângulos que abrem pelo nome do produto.",
        "",
        ...
        "- o ângulo (que desejo ou problema concreto ele ataca)",
...
function systemRedacao(f: Formula): string {
  return [
    ...
    "",
    "EIXO — LEIA ANTES DE TUDO: o vídeo NÃO é sobre a carta. É sobre a",
    "POSSIBILIDADE que a pessoa do outro lado quer. A carta entra só no fecho,",
    "como PROVA de que aquilo existe hoje. Quem abre pelo produto fala com quem",
    "já decidiu comprar; quem abre pelo desejo fala com todo mundo.",
    "",
    "FORMATO DO VÍDEO:",
    ...
    "",
    "OS DOIS PRIMEIROS SEGUNDOS SÃO A POSSIBILIDADE OU O PROBLEMA. Jamais",
    "comece com saudação, apresentação, nome da marca, 'oi' — e jamais comece",
    "pelos números da carta. Isso é botão de pular.",
    "Comece-meio-fim: gancho de possibilidade → mecanismo em fatos → carta do",
    "dia como prova + CTA.",
    "",
