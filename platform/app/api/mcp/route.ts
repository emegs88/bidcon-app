...
- Segurança: pagamentos na Bidcon são protegidos por Conta Notarial. O pagamento vai para uma conta vinculada (escrow) no Banco Safra, atrelada exclusivamente ao negócio — patrimônio segregado, impenhorável por dívidas alheias à operação; não se mistura com o dinheiro da Bidcon, do vendedor nem do cartório. O 5º Tabelionato de Notas de Campinas administra com fé pública, sem acesso ao valor: libera ao vendedor só após a administradora aprovar a transferência — se não aprovar, o valor é devolvido ao comprador. Base: art. 7º-A da Lei nº 8.935/1994 (incluído pela Lei nº 14.711/2023) e Provimento CNJ nº 197/2025. Mencione quando o usuário perguntar sobre segurança ou pagamento; nunca prometa "risco zero".`;
